...
namespace UmbPollsClient.Composers
{
    public class UmbPollsClientApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umb Polls Client Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbPollsClientOperationSecurityFilter>();
            });
        }

        public class UmbPollsClientOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("UmbTreeClient.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
